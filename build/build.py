...
have = [
 ...
 ("Ringer tee — Jamaica (Black/Yellow)","","Tee","","","","",
    "Raglan baby/crop ringer tee, Jamaica flag graphic. Brand unknown. Size to confirm. Look-alike stand-in image (not the exact tee).","jamaica_ringer_alt.jpg"),
 ("Sweat shorts — Grey '404 Not Found'","Urban Heritage","Shorts","L","","","",
    "French-terry drawstring shorts, '404 NOT FOUND' leg print. Made in China. Look-alike stand-in image (not the exact pair).","shorts_404_alt.jpg"),
